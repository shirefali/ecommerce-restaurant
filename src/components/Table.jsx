...
const Table = () => {
  ...
  //reduce quantity or remove the element
  ...
  return (
    <>
      <CartMobileList />
      <table className="table cart-table shadow table-responsive">
        <thead>
          <tr>
            <th>Action</th>
            <th>Product</th>
              ...
              <tr>
                ...
                <td>
                  <div className="d-flex align-items-center">
                    <Button
                      variant="primary"
                      onClick={() => reduceOrRemove(product)}
                    >
                      -
                    </Button>
                    <span
                      className="mx-2 fw-bold text-center px-1 py-1 px-md-3 py-md-2  rounded"
